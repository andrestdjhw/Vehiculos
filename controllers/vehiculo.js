//Importamos el modelo Vehiculo
var Vehiculo = require('../models/vehiculo');

//Indicamos cual es la vista donde se mostraran los valores del modelo
...
exports.vehiculo_create_post = function(req, res){
    var vehi = new Vehiculo (req.body.id, req.body.propietario, req.body.color, 
